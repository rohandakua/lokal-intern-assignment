...
import com.example.lokalinternassignment.presentation.composable.NormalText

@Composable
fun BookmarkScreen(
    navController: NavHostController,
    bookmarkedJobs: List<EachJob>
) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        if (bookmarkedJobs.isEmpty()) {
            Box(
                ...
                NormalText(text = "No Bookmarked Jobs" , textSize = 20)
            }
        } else {
            LazyColumn(
                modifier = Modifier
        ...
        BottomNavigation(
            selectedItemInput = BottomNavItem.Bookmarks,
            onItemSelected = {  },
